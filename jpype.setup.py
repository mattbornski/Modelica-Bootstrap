...
class JPypeSetup(object):
    ...
    def setupMacOSX(self):
        self.javaHome = '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.7.sdk/System/Library/Frameworks/JavaVM.framework/Versions/A/'
        self.jdkInclude = ""
        self.libraries = ["dl"]
